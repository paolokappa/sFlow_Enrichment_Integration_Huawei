...
1. **SrcAS**: Set AS64512 when `SrcAS=0` and `src_ip` belongs to `203.0.113.0/24` or `2001:db8::/32`
2. **DstAS**: Insert AS64512 in `DstASPath` when empty and `dst_ip` belongs to local networks
