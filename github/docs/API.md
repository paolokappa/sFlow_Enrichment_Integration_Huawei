...
|-------|------|-------------|
| `version` | string | sflow-asn-enricher version |
...
```
# HELP sflow_asn_enricher_packets_received_total Total packets received
# TYPE sflow_asn_enricher_packets_received_total counter
sflow_asn_enricher_packets_received_total 125000

# HELP sflow_asn_enricher_packets_forwarded_total Total packets forwarded
# TYPE sflow_asn_enricher_packets_forwarded_total counter
sflow_asn_enricher_packets_forwarded_total 250000

# HELP sflow_asn_enricher_packets_enriched_total Total packets enriched
# TYPE sflow_asn_enricher_packets_enriched_total counter
sflow_asn_enricher_packets_enriched_total 85000

# HELP sflow_asn_enricher_packets_dropped_total Total packets dropped
# TYPE sflow_asn_enricher_packets_dropped_total counter
sflow_asn_enricher_packets_dropped_total 0

# HELP sflow_asn_enricher_packets_filtered_total Total packets filtered by whitelist
# TYPE sflow_asn_enricher_packets_filtered_total counter
sflow_asn_enricher_packets_filtered_total 150

# HELP sflow_asn_enricher_bytes_received_total Total bytes received
# TYPE sflow_asn_enricher_bytes_received_total counter
sflow_asn_enricher_bytes_received_total 45000000

# HELP sflow_asn_enricher_bytes_forwarded_total Total bytes forwarded
# TYPE sflow_asn_enricher_bytes_forwarded_total counter
sflow_asn_enricher_bytes_forwarded_total 90000000

# HELP sflow_asn_enricher_uptime_seconds Uptime in seconds
# TYPE sflow_asn_enricher_uptime_seconds gauge
sflow_asn_enricher_uptime_seconds 9015
...
|--------|------|--------|-------------|
| `sflow_asn_enricher_packets_received_total` | counter | - | Total packets received |
| `sflow_asn_enricher_packets_forwarded_total` | counter | - | Total packets forwarded |
| `sflow_asn_enricher_packets_enriched_total` | counter | - | Packets with modified SrcAS |
| `sflow_asn_enricher_packets_dropped_total` | counter | - | Failed forwards |
| `sflow_asn_enricher_packets_filtered_total` | counter | - | Whitelist drops |
| `sflow_asn_enricher_bytes_received_total` | counter | - | Bytes received |
| `sflow_asn_enricher_bytes_forwarded_total` | counter | - | Bytes forwarded |
| `sflow_asn_enricher_uptime_seconds` | gauge | - | Uptime in seconds |
| `sflow_asn_enricher_destination_packets_sent_total` | counter | `destination` | Per-destination packets |
...
**Enrichment rate:**
```promql
rate(sflow_asn_enricher_packets_enriched_total[1m]) / rate(sflow_asn_enricher_packets_received_total[1m]) * 100
```

**Drop rate:**
```promql
rate(sflow_asn_enricher_packets_dropped_total[1m])
```

**Destination health:**
```promql
sflow_asn_enricher_destination_healthy
```
